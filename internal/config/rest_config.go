...
func NewRest() RestConfig {
	...
	var (
		...
		classRequestTransactionService service.ClassRequestTransactionService = service.NewClassRequestTransactionService(db, classRequestTransactionRepo, userClassRequestRepository, tutorProfileRepository, userRepository, midtransService)
