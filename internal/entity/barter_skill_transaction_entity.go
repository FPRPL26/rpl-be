...
const (
	BarterSkillTransactionStatusRequested  BarterSkillTransactionStatus = "REQUESTED"
...
type BarterSkillTransaction struct {
	...
	MentorProfileID1 uuid.UUID                   `json:"mentor_profile_id_1" gorm:"type:uuid;not null"`
	MentorProfileID2 uuid.UUID                   `json:"mentor_profile_id_2" gorm:"type:uuid;not null"`
